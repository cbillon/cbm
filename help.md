...
| `4.4+`          | derniere mise à jour de la branche : dernière release + fixes
| `4.4.3`         | version spécifique       
| `v4.4.4.2`      | version spécifique : tag                      
| `b097840`       | version spécifique : hash            
...
Le nom du plugin à indiquer est le nom complet selon la règle [franken style](https://moodle.org/mod/glossary/showentry.php?eid=10113&displayformat=dictionary)
...
## Ordre de priorité de prise en compte des paramètres de version

 1. localdev
 2. version
 3. branch

## Gestion des dépendances avec des versions explicites
 
Pour empêcher votre application d'installer et d'utiliser automatiquement la dernière version d'une dépendance, vous devez indiquer une version explicite du composant.
 
 Pour Moodle :
  - en renseignant **version** avec une version explicite (4.5.4), un tag (v4.4.2), un commit
 Pour les plugins : 
  - en utilisant une branche locale (**localdev**)
  - en renseignant **version** avec un tag ou un commit spécifique. 
